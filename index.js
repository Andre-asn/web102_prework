...
const totalGames = GAMES_JSON.reduce((total, _) => {return total + 1}, 0)
...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfunded === 1 ? '1 game remains' : `${numUnfunded} games remain`} unfunded. We need your help to fund these amazing games!`;
